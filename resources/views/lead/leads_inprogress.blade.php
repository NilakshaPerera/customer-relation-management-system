                    ...
                    <table id="jstable" name="jstable" class="table table-striped table-bordered dt-responsive nowrap">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class="column-title" style="display: table-cell;">Attempt Cnt.</th>
                        ...
                        <tbody>
                            <?php foreach ($data['leads'] as $lead) { ?>
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?php echo count($lead->followup) ?></td>
                                    ...
                                    <td class=" last">
                                        <a href="{{action('lead\LeadProcessController@edit', ['id' => $lead->id])}}"><span class="label label-primary">Follow Up</span></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
