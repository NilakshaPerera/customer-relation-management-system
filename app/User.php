...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'role_id', 'line_id' , 'branch_id', 'name', 'email', 'contact', 'empid', 'password', 'image', 'active', 'confirmation_code', 'confirmed', 'remember_token', 'created_at', 'updated_at', 'deleted_at',
    ];
